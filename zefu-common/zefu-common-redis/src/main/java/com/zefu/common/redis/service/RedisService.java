package com.zefu.common.redis.service;
...
public class RedisService {
    ...
    public <T> void addHashMapTime(String key, String field, T value, int timeOut) {
    ...
    public <T> T get(String key, Class<T> clazz) {
        try {
            String value = this.getCacheObject(key);
            if (null == value) {
                return null;
            }
    ...
    public <T> void set(String key, T value, Integer timeout) {
        this.setCacheObject(key, value, Long.valueOf(timeout), TimeUnit.SECONDS);
    }
    ...
    public Boolean setNx(String key, String value, Integer timeout) {
        return redisTemplate.opsForValue().setIfAbsent(key, value, timeout, TimeUnit.SECONDS);
    }

    public Long zRem(String key, String... members) {
        ZSetOperations<String, String> zSetOperations = redisTemplate.opsForZSet();
        return zSetOperations.remove(key, members);
    }
    ...
    public <T> void publish(String channel, T data) {
    ...
    public <T> void addHashMap(String key, String field, T value) {
         this.setCacheMapValue(key, field, value);
    }
}
