...
package com.zefu.common.base.domain;
...
public class DataResult<T> {
    ...
    public boolean isSuccess(){
        if( ErrorEnum.SUCCESS.getCode() == this.code){
            return true;
        }
        return false;
    }

    public static <T> DataResult<T> genResult(ErrorEnum errorEnum, T data) {
    ...
    public static <V> DataResult<V> fail(final String message) {
        ...
        result.setCode(ErrorEnum.FAIL.getCode());
        return result;
    }
     ...
     *
      ...
      */
    public static <V> DataResult<V> fail(final ErrorEnum errorEnum) {
        DataResult<V> result = new DataResult<V>();
        result.setCode(errorEnum.getCode());
        result.setMsg(errorEnum.getMsg());
        return result;
