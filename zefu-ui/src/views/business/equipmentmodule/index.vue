<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="模组名称" prop="moduleName">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:equipmentmodule:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['business:equipmentmodule:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['business:equipmentmodule:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:equipmentmodule:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="equipmentmoduleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="模组名称" align="center" prop="moduleName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="模组名称" prop="moduleName">
          <el-input v-model="form.moduleName" placeholder="请输入模组名称" />
        </el-form-item>
        <el-form-item label="设备名称" prop="equipmentName">
...
<script>
import { listEquipmentmodule, getEquipmentmodule, delEquipmentmodule, addEquipmentmodule, updateEquipmentmodule } from "@/api/business/equipmentmodule";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getEquipmentmodule(id).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除设备模组关联编号为"' + ids + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delEquipmentmodule(ids);
        }).then(() => {
          this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('business/equipmentmodule/export', {
        ...this.queryParams
      }, `business_equipmentmodule.xlsx`)
    }
  }
};
</script>