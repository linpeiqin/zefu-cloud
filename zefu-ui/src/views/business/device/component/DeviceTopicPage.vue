  ...
  data() {
    return {
      ...
      tableData: [
        ...
        { name: '↑设备属性读取响应', topic: 'up/' + this.productCode + '/' + this.deviceCode + '/property/getreply', desc: '系统读取设备属性后，设备向该topic发送数据响应' },
      ...
      deviceInfoApi(this.deviceCode).then(data => {
        ...
        if (nodeType === 'SUB') {
          ...
          const subTable = [
            ...
            { name: '↑设备属性读取响应', topic: 'up/' + gwDeviceCode + '/' + this.deviceCode + '/property/getreply', desc: '系统读取设备属性后，设备向该topic发送数据响应' },
