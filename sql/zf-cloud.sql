...
CREATE TABLE `gen_table` (
  ...
  `tpl_categozf` varchar(200) DEFAULT 'crud' COMMENT '使用的模板（crud单表操作 tree树表操作）',
...
CREATE TABLE `gen_table_column` (
  ...
  `is_quezf` char(1) DEFAULT NULL COMMENT '是否查询字段（1是）',
  `quezf_type` varchar(200) DEFAULT 'EQ' COMMENT '查询方式（等于、不等于、大于、小于、范围）',
